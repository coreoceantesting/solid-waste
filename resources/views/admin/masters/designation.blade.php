                            ...
                            <table id="buttons-datatables" class="table table-bordered nowrap align-middle" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($Designation as $Desi)
                                        ...
                                        <td>{{$Desi->initial}}</td>
                                            <td>
                                                <button class="edit-element btn text-secondary px-2 py-1" title="Edit Designation" data-id="{{ $Desi->id }}"><i data-feather="edit"></i></button>
                                                <button class="btn text-danger rem-element px-2 py-1" title="Delete Designation" data-id="{{ $Desi->id }}"><i data-feather="trash-2"></i> </button>
                                            </td>
                                        </tr>
                                    @endforeach
                            </table>
