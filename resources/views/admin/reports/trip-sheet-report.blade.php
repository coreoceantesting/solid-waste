          ...
          <div class="col-sm-12">
              <div class="row mb-3">
                  <div class="col-md-4">
                      ...
                      <input class="form-control" id="from_date" name="from_date" type="date" value="{{ request()->from_date }}" placeholder="Enter Schedule From">
                  ...
                  <div class="col-md-4">
                      ...
                      <input class="form-control" id="to_date" name="to_date" type="date" value="{{ request()->to_date }}"  placeholder="Enter Schedule To">
